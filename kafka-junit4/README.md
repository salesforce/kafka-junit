...
Kafka-JUnit4 works with all Kafka versions from **0.11.0.x** through **3.4.x**. The library requires your project to explicitly declare/include Kafka in your project's POM dependency list.
